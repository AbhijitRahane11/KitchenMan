...
public class CuttingCounter : BaseCounter, IHasProgress
{
    ...
    public event EventHandler<IHasProgress.OnProgressChangedEventArgs> OnPregressChanged;
        ...
        if (!HasKitchenObject())
        {
            if (player.HasKitchenObject())
            {
                if (HasRecipeWithInput(player.GetKitchenObject().GetKitchenObjectSO()))
                {
                    ...
                    OnPregressChanged?.Invoke(this, new IHasProgress.OnProgressChangedEventArgs
                    {
